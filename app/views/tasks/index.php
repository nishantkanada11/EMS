    ...
    <table border="1" cellpadding="10">
        <thead>
            <tr>
                ...
                ?>
                    <th>
                        <a href="index.php?controller=Task&action=index&sort=<?= $col ?>&order=<?= ($col === $sort) ? ($order === 'ASC' ? 'DESC' : 'ASC') : 'ASC' ?>">
                            <?= $label ?>
                        </a>
                    </th>
                <?php endforeach; ?>
                ...
                <tr>
                    ...
                    <td>
                        <?php if ($_SESSION['user']['role'] !== 'employee'): ?>
                            ...
                            <a href="index.php?controller=Task&action=delete&id=<?= urlencode($task['id']); ?>" onclick="return confirm('Are you sure?')">Delete</a>
                        <?php else: ?>
